...
class Analytics(models.Model):
    ACTIVITY_CHOICES = [
        ...
        ('INTEREST_SELECTION_SKIPPED', 'User skipped category selection tour'),
        ('SKIP_WARNING_OK', 'User ignored sign up skip warning'),
        ('SKIP_WARNING_CANCEL', 'User considered sign up skip warning'),
        ('SIGNUP_CLICKED', 'User clicked signup button from home auth'),
        ('LOGIN_CLICKED', 'User clicked login button from home auth'),
        ('HOME_AUTH_SKIP', 'User clicked skip from home auth page'),
        ('SIGNUP_PAGE_SKIP', 'User clicked skip from signup page'),
        ('LOGIN_PAGE_SKIP', 'User clicked skip from login page'),
        ...
        ('REMOVE_AD_AUTH', 'Logged in User clicked remove ad on google ad card and went on subscription page'),
        ('REMOVE_AD_NOAUTH', 'Non Logged in User clicked remove ad on google ad card and went on home auth page'),
        ...
        ('PROFILE_SIGNOUT', 'User signed out from profile'),
        ('PROFILE_CATEGORY_VISIT', 'User opened category option from profile'),
        ...
        ('PROFILE_SETTING_VISIT', 'User opened app setting page from profile'),
        ('PROFILE_FAQ_VISIT', 'User opened app faq page from profile'),
        ('PROFILE_LOGIN_CLICK', 'User clicked login page from profile'),
        ('DASHBOARD_SEARCH', 'User clicked search icon from dashboard'),
        ('DASHBOARD_VIEW_ALL', 'User clicked view all button from dashboard'),
        ('NOAUTH_SHARE_CLICK', 'Non logged in user clicked share button from fact card'),
        ('NOAUTH_SPEAK_CLICK', 'Non logged in user clicked speak button from fact card and went on home auth page'),
        ('AUTH_SPEAK_CLICK', 'User clicked speak button from fact card and went on subscription page'),
        ('NOAUTH_LIKE_CLICK', 'Non logged in user clicked like button from fact card and went on home auth page'),
        ('NOAUTH_BOOKMARK_CLICK', 'Non logged in user clicked bookmark button from fact card and went on home auth page'),
        ('FLIP_CARD', 'User flipped card in initial session excluding app tour'),
        ('LEARN_MORE', 'User clicked learn more in card '),
        ('IMAGE_CLICK', 'User clicked on image in the card'),
        ...
        ('NOAUTH_FONT_SETTING', 'Non loggedin user clicked font setting and went on home auth'),
        ...
        ('ACCOUNT_SIGNOUT', 'User clicked on sign out button from account setting'),
        ('ACCOUNT_SIGNOUT_COMPLETED', 'User signed out from account setting'),
        ('DASHBOARD_PREMIUM_CARD_AUTH', 'User clicked premium card on dashboard'),
        ('DASHBOARD_PREMIUM_CARD_NOAUTH', 'No logged in User clicked premium card on dashboard and went on home auth'),
        ('DASHBOARD_COIN_WIDGET_AUTH', 'User clicked coin widget on dashboard'),
        ('DASHBOARD_COIN_WIDGET_NOAUTH', 'Non logged in User clicked coin widget on dashboard and went on home auth'),
