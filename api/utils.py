...
ACTIVITY_CHOICES = [
    ...
    ('INTEREST_SELECTION_SKIPPED',
     'User did not selected any category on selection in onboarding'),
    ('CATEGORY_TO_SUBSCRIPTION',
     'User wen on subscription page from selecting premium category during onboarding'),
    ...
    ('SWIPE_DOWN_BACK',
     'User used the swipe down option of stack cards in signup session'),
    ...
    ('STORE_RATING_NO_POPUP',
     'User tried opening the play store rating popup but store rating not available'),
    ('STORE_RATING_WEB_POPUP',
     'User opened the play store rating popup on web platform'),
    ('STORE_POPUP_FEEDBACK', 'User opened feedback while rating on store popup'),
    ('STORE_POPUP_FEEDBACK_CANCEL',
     'User saw feedback and canceled on store_popup'),
    ...
    ('PROFILE_CATEGORY_VISIT',
     'User opened category option from profile in initial session'),
    ...
    ('PROFILE_SETTING_VISIT',
     'User opened app setting page from profile in initial session'),
    ...
    ('CATEGORY_SELECT_NEW',
     'User clicked on select new category from category settings'),
    ('CATEGORY_SELECTED_CATEGORIES',
     'User clicked on selected categories from category settings'),
    ('CATEGORY_REQUEST', 'User clicked on category request from category settings'),
    ('CATEGORY_REQUEST_STATUS',
     'User clicked on check status on category request page'),
    ...
    ('ACCOUNT_PASSWORD_RESET',
     'User clicked on reset password option from account setting'),
    ('ACCOUNT_MANAGE_SUBSCRIPTION',
     'User clicked on manage subscription option from account setting'),
    ...
    ('PLANS_MANAGE_SUBSCRIPTION',
     'User clicked manage subscriptions from subscription page'),
    ...
    ('TRIED_SWIPING_BACK_ADCARD',
     'User tried swiping back ad card in initial session before timer in'),
    ('SPECIAL_CATEGORY_CLICKED','User clicked special category card from dashboard'),
    ('IMAGES_OFF','User turned OFF images from setting'),
    ('IMAGES_ON','User turned ON images from setting'),
    ('AD_WATCHED_COIN','User watched video ad from coin page'),
    ('AD_WATCHED_POPUP','User watched video ad from popup'),
    ('LOW_COIN_POPUP_TO_PREMIUM','User went on premium page from low coin popup'),
    ('NOT_TAKEN_NOTIFICATION_ACTION','User closed notification from popup'),


    ('DELETE_ACCOUNT_DATA',
     'Anonymous user clicked delete account and data on account setting'),
    ('DELETE_ACCOUNT_DATA_WARNING_IGNORE',
     'Anonymous user ignored delete account and data warning and logged out on account setting'),
    ('DELETE_ACCOUNT_DATA_WARNING_CONSIDERED',
     'Anonymous user considered delete account and data warning on account setting'),
    ('SET_EMAIL_PASS_CLICK',
     'Anonymous User clicked on set email and password to backup data from account setting'),
    ('ACCOUNT_DATA_LOST_WARNING',
     'Anonymous User clicked on account data lost warning tile from account setting'),
    ...
    ('CONVERT_EMAIL_EXIST_ERROR',
     'Anonymous User got email already exist error while converted to a real user'),
    ('ANONYMOUS_SETUP_NO_NAME',
     'User proceeded without entering name in sign up process'),
    ('ANONYMOUS_SETUP_WITH_NAME',
     'User proceeded by entering name in sign up process'),
    ('ANONYMOUS_SETUP_NAME_ERROR',
     'User got error related to name in anonymous setup, auth complete without name'),
    ...
    ('SKIP_WARNING_OK',
     '[STOPPED] - User ignored sign up skip warning - [STOPPED]'),
    ('SKIP_WARNING_CANCEL',
     '[STOPPED] - User considered sign up skip warning'),
    ('SIGNUP_CLICKED',
     '[STOPPED] - User clicked signup button from home auth'),
    ('LOGIN_CLICKED',
     '[STOPPED] - User clicked login button from home auth'),
    ('HOME_AUTH_SKIP',
     '[STOPPED] - User clicked skip from home auth page'),
    ('SIGNUP_PAGE_SKIP', '[STOPPED] - User clicked skip from signup page'),
    ('LOGIN_PAGE_SKIP', '[STOPPED] - User clicked skip from login page'),
    ('NOAUTH_SHARE_CLICK',
     '[STOPPED] - Non logged in user clicked share button from fact card'),
    ('NOAUTH_SPEAK_CLICK',
     '[STOPPED] - Non logged in user clicked speak button from fact card and went on home auth page'),
    ('REMOVE_AD_NOAUTH - [STOPPED]',
     'Non Logged in User clicked remove ad on google ad card and went on home auth page'),
    ('NOAUTH_LIKE_CLICK',
     '[STOPPED] - Non logged in user clicked like button from fact card and went on home auth page'),
    ('NOAUTH_BOOKMARK_CLICK',
     '[STOPPED] - Non logged in user clicked bookmark button from fact card and went on home auth page'),
    ('NOAUTH_FONT_SETTING',
     '[STOPPED] - Non loggedin user clicked font setting and went on home auth'),
    ('DASHBOARD_PREMIUM_CARD_NOAUTH',
     '[STOPPED] - No logged in User clicked premium card on dashboard and went on home auth'),
    ('DASHBOARD_COIN_WIDGET_NOAUTH',
     '[STOPPED] - Non logged in User clicked coin widget on dashboard and went on home auth'),
    ('FLIP_CARD',
     '[STOPPED] - User flipped card in initial session excluding app tour'),
    ('AUTH_SPEAK_CLICK',
     '[STOPPED] - User clicked speak button from fact card and went on subscription page'),
    ('PROFILE_LOGIN_CLICK',
     '[Unreachable] - User clicked login page from profile'),
